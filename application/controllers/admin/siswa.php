	...
	function simpan_siswa(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$team=strip_tags($this->input->post('xteam'));
							$email=strip_tags($this->input->post('xemail'));
							
							$this->m_siswa->simpan_siswa($nis,$nama,$jenkel,$kelas,$photo,$team,$email);
					...
					$team=strip_tags($this->input->post('xteam'));
					$email=strip_tags($this->input->post('xemail'));
					$this->m_siswa->simpan_siswa_tanpa_img($nis,$nama,$jenkel,$kelas,$team,$email);
					echo $this->session->set_flashdata('msg','success');
					redirect('admin/siswa');
				}
	...
	function update_siswa(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$team=strip_tags($this->input->post('xteam'));
							$email=strip_tags($this->input->post('xemail'));
							$this->m_siswa->update_siswa($kode,$nis,$nama,$jenkel,$kelas,$photo,$team,$email);
	                    ...
	                    redirect('admin/siswa');
							...
							$team=strip_tags($this->input->post('xteam'));
							$email=strip_tags($this->input->post('xemail'));
							$this->m_siswa->update_siswa_tanpa_img($kode,$nis,$nama,$jenkel,$kelas,$team,$email);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/siswa');
	            } 
