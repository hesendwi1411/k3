...
class Kecelakaan_kerja extends CI_Controller{
	...
	function index(){
		$jum=$this->m_kecelakaan_kerja->kecelakaan_kerja();
        ...
        $limit=7;
        $config['base_url'] = base_url() . 'kecelakaan_kerja/index/';
		...
		$x['data']=$this->m_kecelakaan_kerja->kecelakaan_kerja_perpage($offset,$limit);
		//$x['brt']=$this->berita->beritaasc();
		$this->load->view('depan/v_kecelakaan_kerja',$x);
	}
