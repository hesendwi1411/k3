...
<head>
  ...
  <title>B-K3 Ameya | Emergency</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Emergency Call</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
