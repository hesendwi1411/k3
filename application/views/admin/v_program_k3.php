...
<head>
  ...
  <title>B-K3 Ameya | Master | P.K3</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Program P2K3</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-striped" style="font-size:13px;">
				...
				<?php
					...
					foreach ($data->result_array() as $i) :
                       ...
                       $program_nama=$i['program_nama'];
                       $program_tahun=$i['program_tahun'];
                    ?>
                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $program_nama;?></td>
                  <td><?php echo $program_tahun;?></td>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/program_k3/simpan_program_k3'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Program P2K3</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xprogram_nama" class="form-control" id="inputUserName" placeholder="Nama Program" required>
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tahun Program</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xprogram_tahun" class="form-control" id="inputUserName" placeholder="Tahun Program..." required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $program_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Program P2K3</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/program_k3/update_program_k3'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <input type="text" name="xprogram_nama" class="form-control" id="inputUserName" value="<?php echo $program_nama;?>" placeholder="Nama program " required>
                                        </div>
                                    </div>
									 <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tahun program</label>
                                        <div class="col-sm-7">
											<input type="hidden" name="kode" value="<?php echo $program_id;?>"/> 
                                            <input type="text" name="xprogram_tahun" class="form-control" id="inputUserName" value="<?php echo $program_tahun;?>" placeholder="Tahun program " required>
                                        </div>
                                    </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $department_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Program P2K3</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/program_k3/hapus_program_k3'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							<input type="hidden" name="kode" value="<?php echo $program_id;?>"/> 
                            <p>Apakah Anda yakin mau menghapus <b><?php echo $program_nama;?></b> ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Program P2K3 Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Program P2K3 berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Program P2K3 Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
