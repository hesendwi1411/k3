...
?>
<?php
$conn=@mysqli_connect("192.168.70.250","beacukai","beacukai") or die("Tidak Terkoneksi");
...
<head>
  ...
  <title>B-K3 Ameya | Kunjungan Karyawan</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Data Kunjungan Klinik Bulan <?php echo getBulan(date('m')); ?>
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Kunjungan Karyawan</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <!--  <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#ModalFilter"><span class="fa fa-plus">Filter Date</span></a>  -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:12px;">
               ...
               <tr>
                ...
                <tbody>
			<?php										
					$query=mysqli_query($conn,"SELECT * FROM penyakit ORDER BY nama_penyakit ASC ");
					$no=1;
					while($r=mysqli_fetch_array($query)){
					?>					
						<tr bgcolor="#fff">
							<td ><?php echo $no; ?></td>
							<td ><?php echo $r['kode_pen']; ?></td>
                            <td><?php echo $r['nama_penyakit']; ?></td>
                            
                            <?php 
                            $id_penyakit=$r['id_penyakit']; 
                            $queryKaryawan=mysqli_query($conn,"SELECT * FROM penyakit, rekammedik, pasien WHERE penyakit.id_penyakit=rekammedik.id_penyakit AND penyakit.id_penyakit='$id_penyakit' AND pasien.kodePasien=rekammedik.kodepasien AND date_format(rekammedik.tgl,'%m%y')=date_format(curdate(),'%m%y')");
                            $nKaryawan=mysqli_num_rows($queryKaryawan);
						
                            ?>
							<td><?php echo $nKaryawan; ?></td>
