...
<head>
  ...
  <title>B-K3 Ameya | Master | Diagnosis</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Diagnosis</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $diagnosis_nama;?></td>
                  
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $diagnosis_id;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $diagnosis_id;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
...
<!--Modal Add Pengguna-->
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/diagnosis/simpan_diagnosis'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Diagnosis</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xdiagnosis_nama" class="form-control" id="inputUserName" placeholder="Diagnosis" required>
                                        </div>
                                    </div>
		...
		<?php foreach ($data->result_array() as $i) :
            ...
            ?>
	<!--Modal Edit Pengguna-->
        <div class="modal fade" id="ModalEdit<?php echo $diagnosis_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/diagnosis/update_diagnosis'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Diagnosis</label>
                                        <div class="col-sm-7">
											<input type="hidden" name="kode" value="<?php echo $department_id;?>"/> 
                                            <input type="text" name="xdiagnosis_nama" class="form-control" id="inputUserName" value="<?php echo $diagnosis_nama;?>" placeholder=" Diagnosis " required>
                                        </div>
                                    </div>
	...
	<!--Modal Hapus Pengguna-->
        <div class="modal fade" id="ModalHapus<?php echo $department_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus diagnosis</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/diagnosis/hapus_diagnosis'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							<input type="hidden" name="kode" value="<?php echo $diagnosis_id;?>"/> 
                            <p>Apakah Anda yakin mau menghapus <b><?php echo $diagnosis_nama;?></b> ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "diagnosis Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "diagnosis berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
