		...
		<!-- Content Seciton -->
        	<div id="content_section">
                ...
                <div class="staticblock2">
                    	<a href="#"><img  src="<?php echo base_url().'template/images/staticimge1.gif'?>"  alt="" /></a>
                        <h4>VISI</h4><br/>
                        <p>Ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel visi ini adalah sampel ini adalah sampel visi ini adalah sampel visi.</p><br/>
                        <h4>MISI</h4><br/>
                        <p>Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi. Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi.Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi Ini adalah sampel misi</p>
