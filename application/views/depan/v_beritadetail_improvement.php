                         	...
                         	<div id="content2">
                            	<!-- Blog Detail -->
                                	<div class="blog_detail">
                                		<!--<a href="#"><img class="" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan1'];?>" alt="" /></a> -->
                                        <div class="bloginfo">
                                        	<h5><?php echo $b['improvement_cluster'];?> </h5>
                                            <div class="info info1">
												<span class="postedby">Status: <?php echo $b['improvement_status'];?></span>
                                            	<span class="postedby">Added by: <?php echo $b['improvement_author'];?></span>
                                                <span class="lastupdte">Tanggal: <i><?php echo $b['improvement_tanggal_kejadian'];?></i></span> 
                                            	
                                            </div>
											  
                                            <div class="clear"></div>
											<div class="info info1">
												<h5 style="margin-right: 20px;">Informasi</h5>
												<tr>
                                              	<td>Cluster</td>
                                                <td>:</td>
												<?php echo $b['improvement_cluster'];?>
												</tr><br/>
												<tr>
                                              	<td>Penanggung jawab</td>
                                                <td>:</td>
												<?php echo $b['improvement_ketua'];?>
												</tr>
												<tr><br/>
                                              	<td>Area perbaikan</td>
                                                <td>:</td>
												<?php echo $b['improvement_area_perbaikan'];?>
												</tr><br/>
											    <tr>
                                              	<td>Masalah</td>
                                                <td>:</td>
												<?php echo $b['improvement_masalah'];?>
												</tr> <br/>
												<tr>
                                              	<td>Tangal kejadian</td>
                                                <td>:</td>
												<?php echo $b['improvement_tanggal_kejadian'];?>
												</tr>
												<h5 style="margin-right: 20px;">Rencana</h5>
												<tr>
                                              	<td>Perbaikan</td>
                                                <td>:</td>
												<?php echo $b['improvement_perbaikan'];?>
												</tr><br/>
												<tr>
                                              	<td>Perbaikan by</td>
                                                <td>:</td>
												<?php echo $b['improvement_by_rencana'];?>
												</tr>
												<tr><br/>
                                              	<td>Tanggal rencana perbaikan</td>
                                                <td>:</td>
												<?php echo $b['improvement_tanggal_rencana'];?>
												</tr><br/>
												<h5 style="margin-right: 20px;">Target</h5>
												<tr>
                                              	<td>Status</td>
                                                <td>:</td>
												<?php echo $b['improvement_status'];?>
												</tr><br/>
												<tr>
                                              	<td>Progres</td>
                                                <td>:</td>
												<?php echo $b['improvement_progres'];?>
												</tr>
												<tr><br/>
                                              	<td>Penyelesaian by</td>
                                                <td>:</td>
												<?php echo $b['improvement_by_target'];?>
												</tr><br/>
												<td>Tanggal penyelesaian</td>
                                                <td>:</td>
												<?php echo $b['improvement_tanggal_penyelesaian'];?>
												</tr><br/><br/>
												
												<h5 style="margin-right: 20px;">Foto</h5>
												
												<div class="info info1">
													<ul>
														<td>Finding</td><br/><br/>
														  <li><a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan1'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan1'];?>"  alt="" /></a>
															<a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan2'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan2'];?>"  alt="" /></a>
															<a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan3'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan3'];?>"  alt="" /></a>
															<a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan4'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_temuan4'];?>"  alt="" /></a></li>
															<td>Finished</td><br/><br/>
														  <li><a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan1'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan1'];?>"  alt="" /></a>
															<a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan2'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan2'];?>"  alt="" /></a>
															<a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan3'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan3'];?>"  alt="" /></a>
															<a href="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan4'];?>" rel="galleryimg" class="galleryimg" title="" ><img width="108" height="101" src="<?php echo base_url().'assets/images/improvement/'.$b['improvement_photo_perbaikan4'];?>"  alt="" /></a></li>
												  </ul>
												<div class="hdiv">&nbsp;</div>
												</div>
