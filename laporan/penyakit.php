...
<html>
	...
	<body>
		...
		<table class="table" border="1px">
			<tr class="head">
				<td width="20">NO. </td><td width="50">KODE </td><td width="150">NAMA PENYAKIT</td><td width="60">JUMLAH</td>
			</tr>
			...
			<?php										
                ...
                <tr>
                   ...
                   <!-- <td align="center"><?php 
                            ...
                            echo $cc=mysqli_num_rows($c);
                            ?></td> -->
                    <td align="center"><h4><?php echo $aa+$bb+$cc; ?></h4></td>
                </tr>
